...
// Версию поднимаем при каждой правке кэшируемого: при активации старые кэши
// удаляются целиком. Здесь это особенно важно — в кэше v6 успели осесть ответы
// /api/, и их надо выбросить, а не пытаться обновить по одному.
const CACHE = 'fittimer-v7';
const ASSETS = [
  './',
  './index.html',
