...
const {createDocumentStore}=require('../lib/document-store');
const calls=[];
...
(async()=>{
  ...
  try{
    ...
    delete require.cache[require.resolve('../lib/supabase-document-store')];
    delete require.cache[require.resolve('../lib/sync-shadow')];
    const Shadow=require('../lib/sync-shadow');
