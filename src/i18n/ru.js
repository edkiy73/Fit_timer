const I18N_RU = {
  ...
  'account.signOutQuestion': "Выйти из аккаунта {email}? Программы, статистика, вес и фото останутся на этом телефоне. Подписка останется у аккаунта, а защиту биометрией после нового входа можно включить снова.",
