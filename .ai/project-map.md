...
| `config/appbase-manifest.json`, `scripts/extract-appbase.mjs` | AppBase Core file list + standalone check (`npm run check:appbase`) | Core boundary / monorepo workspace |
