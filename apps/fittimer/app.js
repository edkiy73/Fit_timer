...
if(globalThis.__FIT_TEST_MODE__ === true){
  ...
  __fitExpose("FitAIProtocol", () => FitAIProtocol);
  ...
  __fitExpose("appLocalePreference", () => appLocalePreference);
  __fitExpose("appLocale", () => appLocale);
  __fitExpose("appLocaleStored", () => appLocaleStored);
  __fitExpose("normalizeLocale", () => normalizeLocale);
  __fitExpose("systemLocale", () => systemLocale);
  __fitExpose("normalizeLocalePreference", () => normalizeLocalePreference);
  __fitExpose("resolveLocalePreference", () => resolveLocalePreference);
  __fitExpose("profileLocalePreference", () => profileLocalePreference);
  __fitExpose("t", () => t);
  __fitExpose("applyI18nValue", () => applyI18nValue);
  __fitExpose("applyI18n", () => applyI18n);
  __fitExpose("syncAccessibility", () => syncAccessibility);
  __fitExpose("loadAppLocale", () => loadAppLocale);
  __fitExpose("setAppLocale", () => setAppLocale);
  __fitExpose("localeTag", () => localeTag);
  __fitExpose("aiOutputLanguage", () => aiOutputLanguage);
  __fitExpose("aiCanonicalEnglish", () => aiCanonicalEnglish);
  __fitExpose("aiCanonicalListEnglish", () => aiCanonicalListEnglish);
  __fitExpose("CANONICAL_LABEL_KEYS", () => CANONICAL_LABEL_KEYS);
  __fitExpose("CANONICAL_DESC_KEYS", () => CANONICAL_DESC_KEYS);
  __fitExpose("canonicalLabel", () => canonicalLabel);
  __fitExpose("canonicalDescription", () => canonicalDescription);
