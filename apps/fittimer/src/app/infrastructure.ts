import { createStorage, type ExternalStorage, type StorageCore } from '@appbase/core/storage.js';
import {
  createClient,
  type ObservabilityClient,
  type Platform
} from '@appbase/core/observability.js';
...
export function createProductInfrastructure(
  ...
  const storageOptions = {
    ...
    storeName: 'kv',
    mirrorKeys: ['account']
  } satisfies import('@appbase/core/storage.js').StorageOptions;
