...
const identityModuleSource = fs.readFileSync('../../packages/core/src/core/identity.ts', 'utf8');
...
ok('product identity owns the explicit Identity Core dependency',
  /from ['"]@appbase\/core\/identity\.js['"]/.test(fs.readFileSync('src/app/identity.ts','utf8')));

const syncModuleSource = fs.readFileSync('../../packages/core/src/core/sync.ts', 'utf8');
...
ok('product sync schema owns the explicit Sync Core dependency',
  /from ['"]@appbase\/core\/sync\.js['"]/.test(fs.readFileSync('src/app/sync-schema.ts','utf8')));

const storageModuleSource = fs.readFileSync('../../packages/core/src/core/storage.ts', 'utf8');
...
ok('product infrastructure owns the explicit Storage Core dependency',
  /from ['"]@appbase\/core\/storage\.js['"]/.test(fs.readFileSync('src/app/infrastructure.ts','utf8')));

const observabilityModuleSource = fs.readFileSync('../../packages/core/src/core/observability.ts', 'utf8');
...
ok('product infrastructure owns the explicit Observability Core dependency',
  /from ['"]@appbase\/core\/observability\.js['"]/.test(fs.readFileSync('src/app/infrastructure.ts','utf8')));

const notificationsModuleSource = fs.readFileSync('../../packages/core/src/core/notifications.ts', 'utf8');
...
const coreSources = [
  ...
  ...fs.readdirSync('../../packages/core/src/core').filter(name => name.endsWith('.ts'))
    .map(name => fs.readFileSync('../../packages/core/src/core/' + name, 'utf8'))
].join('\n');
...
ok('ESM Core build script exists',
  typeof pkg.scripts['build:esm'] === 'string' && /build-esm/.test(pkg.scripts['build:esm']));
...
const analyticsCoreSource = fs.readFileSync('../../packages/core/server/analytics-core.js','utf8');
...
const nativeNotificationSource = fs.readFileSync('../../packages/core/src/core/native-notifications.ts','utf8');
...
const mobileCoreSource = fs.readFileSync('../../packages/core/src/core/mobile.ts','utf8');
...
const speechCoreSource = fs.readFileSync('../../packages/core/src/core/speech.ts','utf8');
...
ok('mobile adapter delegates native speech transport to Core',
  /from ['"]@appbase\/core\/speech\.js['"]/.test(mobileAdapterSource)
...
ok('mobile adapter owns explicit native/mobile Core dependencies',
  /from ['"]@appbase\/core\/native-notifications\.js['"]/.test(mobileAdapterSource)
  && /from ['"]@appbase\/core\/mobile\.js['"]/.test(mobileAdapterSource)
...
ok('product sync schema is a real ESM module',
  /from ['"]@appbase\/core\/sync\.js['"]/.test(productSyncModuleSource)
...
ok('product infrastructure composes Core through explicit imports',
  /from ['"]@appbase\/core\/storage\.js['"]/.test(productInfrastructureSource)
  && /from ['"]@appbase\/core\/observability\.js['"]/.test(productInfrastructureSource)
...
ok('product identity composes generic Identity Core through imports',
  /from ['"]@appbase\/core\/identity\.js['"]/.test(productIdentitySource)
...
ok('FitTimer profile extension stays in product layer',
  ...
  && !/gender|age/.test(fs.readFileSync('../../packages/core/src/core/identity.ts','utf8')));
...
const genericServerSources = {
  '../../packages/core/server/ai.js': fs.readFileSync('../../packages/core/server/ai.js','utf8'),
  '../../packages/core/server/push.js': fs.readFileSync('../../packages/core/server/push.js','utf8'),
  '../../packages/core/server/mail.js': fs.readFileSync('../../packages/core/server/mail.js','utf8'),
  '../../packages/core/server/ai-endpoint.js': fs.readFileSync('../../packages/core/server/ai-endpoint.js','utf8'),
  '../../packages/core/server/ai-action-registry.js': fs.readFileSync('../../packages/core/server/ai-action-registry.js','utf8'),
  '../../packages/core/server/product-core.js': fs.readFileSync('../../packages/core/server/product-core.js','utf8')
};
...
const authCoreSource = fs.readFileSync('../../packages/core/server/auth-core.js','utf8');
...
const syncCoreSource = fs.readFileSync('../../packages/core/server/sync-core.js','utf8');
