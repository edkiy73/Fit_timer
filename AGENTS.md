...
- Generated compatibility files: `index.html`, `style.css`, `app.js`, and `src/core/*.runtime.js`; rebuild with the matching build scripts and do not edit them directly.
