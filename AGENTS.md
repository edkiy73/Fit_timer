...
- Generated compatibility files: `index.html`, `style.css`, `app.js`, `native-notifications.js`, and `mobile-core.js`; rebuild with the matching build scripts and do not edit them directly.
