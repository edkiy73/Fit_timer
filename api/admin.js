...
const { handleAdminAccounts, ensureAccountIndex } = require('../lib/admin/core/accounts');
...
module.exports = async (req, res) => {
  ...
  if(a === 'campaign_send'){
    ...
    return send(res,200,{ok:true,preview,cursor:next,done:next>=unique.length,total:unique.length,
  ...
  if(a === 'catalog_ai_create'){
    ...
    const request=[
      ...
      'Goal: '+(IMAGE_GOAL_LABELS[cat]||cat)+'.',
