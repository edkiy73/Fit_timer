...
async function handleAI(req, res){
  ...
  try{
    ...
    const result = await generate(type, settings, prompt, {
      aspectRatio,
    ...
    const malformed = !!validation || /malformed_response|missing_fields|exercise_count|no_exercises|no_days|bad_image/.test(String(e && e.message || ''));
