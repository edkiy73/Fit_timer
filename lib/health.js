...
async function collectHealth(){
  ...
  return {
    ...
    services:{
      ...
      supabase:{configured:!!supabase.configured,connected:!!(supabaseProbe && supabaseProbe.ok),latencyMs:supabaseProbe?supabaseProbe.latencyMs:null,envSeen:supabase.seen||[]},
